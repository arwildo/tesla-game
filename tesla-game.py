...
pygame.display.set_caption('Tesla Car Game',
                           'Tesla AI Car Game automatic detect road')
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
    if gas.y > 500:
        gas = gas_car(random.randint(55, 475), random.randint(-500, -300), 64,
                      64, 600)
    gas.move()

    if gas2.y > 500:
        gas2 = gas_car2(random.randint(100, 475), random.randint(-450, -400),
                        64, 64, 600)
    gas2.move()

    if gas3.y > 500:
        gas3 = gas_car3(random.randint(100, 475), random.randint(-600, -300),
                        64, 64, 600)
    gas3.move()

    if gas4.y > 500:
        gas4 = gas_car4(random.randint(100, 475), random.randint(-600, -400),
                        64, 64, 600)
    gas4.move()

    if tesla.hitbox[1] - tesla.hitbox[3] < gas.hitbox[1] + gas.hitbox[
            3] and tesla.hitbox[1] + tesla.hitbox[3] > gas.hitbox[1]:
        if tesla.hitbox[0] + tesla.hitbox[2] > gas.hitbox[0] and tesla.hitbox[
                0] - tesla.hitbox[2] < gas.hitbox[0] + gas.hitbox[2]:
            gas.hit()
    if tesla.hitbox[1] - tesla.hitbox[3] < gas2.hitbox[1] + gas2.hitbox[
            3] and tesla.hitbox[1] + tesla.hitbox[3] > gas2.hitbox[1]:
        if tesla.hitbox[0] + tesla.hitbox[2] > gas2.hitbox[0] and tesla.hitbox[
                0] - tesla.hitbox[2] < gas2.hitbox[0] + gas2.hitbox[2]:
            gas2.hit()
    if tesla.hitbox[1] - tesla.hitbox[3] < gas3.hitbox[1] + gas3.hitbox[
            3] and tesla.hitbox[1] + tesla.hitbox[3] > gas3.hitbox[1]:
        if tesla.hitbox[0] + tesla.hitbox[2] > gas3.hitbox[0] and tesla.hitbox[
                0] - tesla.hitbox[2] < gas3.hitbox[0] + gas3.hitbox[2]:
            gas3.hit()
    if tesla.hitbox[1] - tesla.hitbox[3] < gas4.hitbox[1] + gas4.hitbox[
            3] and tesla.hitbox[1] + tesla.hitbox[3] > gas4.hitbox[1]:
        if tesla.hitbox[0] + tesla.hitbox[2] > gas4.hitbox[0] and tesla.hitbox[
                0] - tesla.hitbox[2] < gas4.hitbox[0] + gas4.hitbox[2]:
            gas4.hit()
    ...
    if keys[pygame.K_LEFT] and tesla.x > tesla.vel + tesla.road_size:
        tesla.x -= tesla.vel
    if keys[pygame.
            K_RIGHT] and tesla.x < win_wid - tesla.wid - tesla.road_size - tesla.vel:
        tesla.x += tesla.vel
